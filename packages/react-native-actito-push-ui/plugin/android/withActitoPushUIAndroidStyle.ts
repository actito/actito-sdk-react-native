...
const TRANSLUCENT_STYLE_THEME = 'Theme.Actito.PushUI.Translucent';
const PUSH_UI_ACTIVITY = 'com.actito.push.ui.NotificationActivity';

const withApplyCustomStyle: ConfigPlugin<ActitoPushUIPluginProps> = (
  config,
  props
) => {
...
const withCreateTranslucentStyle: ConfigPlugin<ActitoPushUIPluginProps> = (
  config,
  props
) => {
...
const withApplyTranslucentStyle: ConfigPlugin<ActitoPushUIPluginProps> = (
  config,
  props
) => {
  return withAndroidManifest(config, (newConfig) => {
...
const withRemoveStyle: ConfigPlugin<ActitoPushUIPluginProps> = (
  config,
  props
) => {
  return withAndroidManifest(config, (newConfig) => {
...
export const withActitoPushUIAndroidStyle: ConfigPlugin<
