...
@interface ActitoModule () <ActitoModuleDelegate>
@end

@implementation ActitoModule {
    ActitoPlugin *plugin;
}
...
{
    return std::make_shared<facebook::react::NativeActitoModuleSpecJSI>(params);
}
#endif
