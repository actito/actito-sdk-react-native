...
export const BackgroundCallbackRegionEntered = async (region: ActitoRegion) => {
  await logCustomBackgroundEvent('RegionEntered', region);
};

export const BackgroundCallbackRegionExited = async (region: ActitoRegion) => {
  await logCustomBackgroundEvent('RegionExited', region);
};

export const BackgroundCallbackBeaconEntered = async (beacon: ActitoBeacon) => {
  await logCustomBackgroundEvent('BeaconEntered', beacon);
};

export const BackgroundCallbackBeaconExited = async (beacon: ActitoBeacon) => {
